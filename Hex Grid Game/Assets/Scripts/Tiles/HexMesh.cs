...
public class HexMesh : MonoBehaviour
{
    ...
    private void TriangulateConnection(HexDirection direction, HexCell cell, Vector3 v1, Vector3 v2)
    {
        ...
        v3.y = v4.y = neighbor.Elevation * HexDefinition.elevationStep;
        ...
        if (direction <= HexDirection.E && nextNeighbor != null)
        {
            ...
            v5.y = nextNeighbor.Elevation * HexDefinition.elevationStep;
        ...
        )
    {
        ...
        if (leftEdgeType == HexDefinition.HexEdgeType.Slope)
        {
            ...
            if (rightEdgeType == HexDefinition.HexEdgeType.Flat)
            {
    ...
    {
        float b = 1.0f / (float)(rightCell.Elevation - beginCell.Elevation);
    ...
    {
        float b = 1.0f / (float)(leftCell.Elevation - beginCell.Elevation);
